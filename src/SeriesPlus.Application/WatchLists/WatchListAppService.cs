...
namespace SeriesPlus.WatchLists
{
    ...
    {
        private readonly IRepository<WatchList, int> _watchListRepository; // acceso al repositorio de listas de seguimiento
        ...
        public async Task AddSerieAsync(int serieId) // Método para agregar una serie a la lista
        {
            ...
            {
                watchlist = new WatchList();      // Inicializamos la colección de series para poder agregar elementos                                           

...
{
    [DbContext(typeof(SeriesPlusDbContext))]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeriesPlus.Domain.Notificaciones.Notificacion", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("SeriesPlus.ListasDeSeguimiento.ListaDeSeguimiento", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("SeriesPlus.Series.Episodio", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("SeriesPlus.Series.Temporada", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("SeriesPlus.Series.Episodio", b =>
            {
                b.HasOne("SeriesPlus.Series.Temporada", "Temporada")
                    .WithMany("Episodios")
            ...
            modelBuilder.Entity("SeriesPlus.Series.Serie", b =>
            {
                b.HasOne("SeriesPlus.ListasDeSeguimiento.ListaDeSeguimiento", null)
                    .WithMany("Series")
            ...
            modelBuilder.Entity("SeriesPlus.Series.Temporada", b =>
            {
                b.HasOne("SeriesPlus.Series.Serie", "Serie")
                    .WithMany("Temporadas")

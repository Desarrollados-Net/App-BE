import type { ReviewDto, CreateUpdateSerieDto, SerieDto, TemporadaDto } from './models';
...
export class SerieService {
  ...
  calificarSerie = (input: ReviewDto, config?: Partial<Rest.Config>) =>
  ...
  modificarCalificacion = (input: ReviewDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, void>({
      method: 'POST',
